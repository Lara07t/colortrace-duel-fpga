...
//     // 115,200 slots of 128 bits
//     localparam [23:0] MAX_ADDR  = (1280*720*2)/16 - 1;       // 115,199
...
//         write_address <= '0;
//         // last pix
//     end else if (write_axis_valid && write_axis_ready && write_axis_tlast) begin
//         write_address <= '0;
//         // cam fifo transfer 128 
//         // inc 1
//     end else if (write_axis_valid && write_axis_ready) begin
//         write_address <= (write_address == MAX_ADDR) ? 24'd0 : (write_address + 24'd1);
//     end
//     end
...
//         // contr accepts new read request
//     end else if (read_request_valid && read_request_ready) begin
//         read_request_address <= (read_request_address == MAX_ADDR) ? 24'd0 : (read_request_address + 24'd1);
//     end
//     end
...
//     .rst (rst),
//     .write (memrequest_en),
//     .command_in ({memrequest_write_enable, memrequest_addr}), 
//     .command_out(cf_dout),
...
//     assign read_axis_tlast = read_axis_valid && (read_response_address == MAX_ADDR);
